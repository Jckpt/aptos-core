...
module aptos_framework::simple_delegations {
    ...
    public entry fun request_commission(operator: address, delegator: address) acquires Delegations {
        ...
        let (total_active_stake, accumulated_rewards) = get_accumulated_rewards(delegation);
    ...
    fun record_unpaid_commission(delegation: &mut Delegation, creditor: address): (u64, u64, u64) {
        ...
        let (total_active_stake, accumulated_rewards) = get_accumulated_rewards(delegation);
        let new_commission = accumulated_rewards * delegation.commission_percentage / 100;
    ...
    fun get_accumulated_rewards(delegation: &mut Delegation): (u64, u64) {
        ...
        (total_active_stake, accumulated_rewards)
    }
    ...
    public entry fun test_end_to_end(
        ...
        request_commission(operator_address, delegator_address);
        ...
        withdraw_commission(operator_address, delegator_address);
    ...
    public entry fun test_delegator_cannot_delegate_with_invalid_amount(
        aptos_framework: &signer,
        delegator: &signer,
        operator: &signer,
    ) acquires Delegations {
        setup_delegation(aptos_framework, delegator, operator, 0, 100);
    }
    ...
    public entry fun test_operator_cannot_request_commission_from_inactive_delegation(
        ...
        request_commission(operator_address, signer::address_of(delegator));
    }
    ...
    public entry fun test_delegator_can_switch_operator(
        ...
        request_commission(operator_2_address, delegator_address);
        ...
        assert!(get_last_recorded_total_stake(delegator_address, operator_2_address) == expected_total_active_stake, 0);
        fast_forward_to_unlock();
        withdraw_commission(operator_2_address, delegator_address);
